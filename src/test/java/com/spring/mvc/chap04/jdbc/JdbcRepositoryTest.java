...
class JdbcRepositoryTest {
    ...
    @Test
    @DisplayName("회원번호가 2번인 회원의 이름과 나이를 수정해야한다.")
    void updateTest() {
        ...
        // when: 테스트를 목표를 확인하여 실제 테스트가 진행되는 구간
        repository.update(p);
    ...
    void findAllTest() {
        ...
        // 나는 people.size() (피플의 사이즈가)11과 같은 것임을 단언하겠다!
        assertEquals(11, people.size());
        assertNotNull(people); // people은 null이 아님을 단언

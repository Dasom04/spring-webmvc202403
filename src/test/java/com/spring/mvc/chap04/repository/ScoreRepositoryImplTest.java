...
class ScoreRepositoryImplTest {
    ...
    @Test
    @DisplayName("새로운 성적 정보를 save메서드를 통해 추가한다.")
    void saveTest() {

        ScoreRequestDTO dto = new ScoreRequestDTO("유태오", 60, 100, 74);
    ...
    @Test
    @DisplayName("3번 학생의 이름은 박영희일 것이다.")
    void findOneTest() {
        // given
        int stuNum = 3;
    ...
    @Test
    @DisplayName("1번 학생을 삭제한 후 1번 학생을 조회 했을때 조회되지 않아야 한다.")
    void deleteTest() {
        // given
        int stuNum = 1;

...
<body>
    ...
    취미:
    <input type="checkbox" name="hobby" value="score"> 축구
    ...
    <script>
        ...
        $sendBtn.onclick = e => {
                ...
                // 여러개의 체크박스 중 체크가 된 요소의 갑만 arr에 추가
                [...$hobby].forEach($check => {
                    if ($check.checked) {
                ...
                */
                ...
                const fetchResult = 
                    ...
                    // fetc함수를 통해 비동기 방식의 요처을 봰면 응답 결과로 Promise타입의 객체가 리턴됨.
                    ...
                    // Promise 객체에 담긴 여러 정보 중 PromiseResult에 담긴 Response 객체를 콜백 함수의 매개값으로 받아서

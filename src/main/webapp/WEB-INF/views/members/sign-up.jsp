...
<body>
  ...
  <script>
    ...
    // 입력값 검증 통과 여부 배열
    const checkResultList = [false, false, false, false, false]; // 제대로 입력이 되지않아서 false인 상태.
    ...
    // 이미지 영역을 클릭하면 input=file을 클릭한 것과 동일한 효과를 내자.
    $profile.onclick = e => {
      $fileInput.click();
    }
    ...
    $fileInput.onchange = e => {
      ...
      // 파일의 바이트데이터를 읽어서 img태그에 src속성에 넣으려면

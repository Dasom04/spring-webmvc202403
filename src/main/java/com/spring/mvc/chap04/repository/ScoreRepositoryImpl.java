...
public class ScoreRepositoryImpl implements ScoreRepository {
    ...
    class ScoreMapper implements RowMapper<Score> {
        ...
        // Spring -jdbc의 핵심 개체인 JdbcTemplate의 의존성 주입 (생성자 주입)
        ...
        public Score findOne(int stuNum) {
            ...
            try {
                // queryForObject 조회 결과가 없을 시 예외가 발생합니다.
            ...
            // return jdbcTemplate.queryForObject(sql, new ScoreMapper(), stuNum); 으로 간추릴 수 있음

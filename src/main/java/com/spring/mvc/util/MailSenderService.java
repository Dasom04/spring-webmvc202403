...
public class MailSenderService {
    ...
    private final JavaMailSender mailSender; // 주입받기
    ...
    public String joinEmail(String email) { // 컨트롤러로 부터 이메일을 전달 받음.

        int authNum = makeRandomNumber(); // 인증번호 생성
        String setFrom = "slz_952@naver.com"; // EmailConfig에 설정한 발신용 이메일과 똑같이!
